...
#if !defined(SDL_TRIPLEBUF)
#warning "Triple buffering not available, check if libSDL has support for triple buffering or ignore if you are bug testing"
...
#elif defined(OPENDINGUX_JZ4770)

#define FONT_DEFAULT_SIZE 16

#define SCREEN_WIDTH  (screen_video->w)
#define SCREEN_HEIGHT (screen_video->h)

#define ADJUST_FONT_SIZE_DYNAMIC
...
#define VIDEOMODE_BITS 16
#define SCREEN_BUFFER_BPP 16
#define VIDEOMODE_FLAGS (SDL_HWSURFACE|SDL_TRIPLEBUF)
#define CONVERT_16BPP
