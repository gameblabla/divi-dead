...
OPTION_GAME_MENU main_menu_save_load[] = {
...
OPTION_GAME_MENU extra_menu_gallery[] = {
...
OPTION_GAME_MENU main_menu_options[] = {
...
OPTION_GAME_MENU main_menu_langs[] = {
...
OPTION_GAME_MENU main_menu_ingame[] = {
...
OPTION_GAME_MENU main_menu_title[] = {
...
//debug_global
OPTION_GAME_MENU extra_menu_title_nodebug[] = {
	{ percent_option  , OPTION_GALLERY },      // PERCENT
	{ lang_texts[6]   , OPTION_SAVE_IMAGE },   // SCREENSHOT
	{ NULL            , NULL },
};

OPTION_GAME_MENU extra_menu_title_debug[] = {
	{ percent_option  , OPTION_GALLERY },            // PERCENT
	{ lang_texts[6]   , OPTION_SAVE_IMAGE },         // SCREENSHOT
